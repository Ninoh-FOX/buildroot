...
if test -f ../../output/images/uzImage.bin
then
    mkdir ../../output/images/kernel
    cat ../../output/images/uzImage.bin ../../output/images/rg280v.dtb > ../../output/images/kernel/uzImage.bin
	SIZE=$(stat -Lc %s ../../output/images/kernel/uzImage.bin)
	echo "uzImage.bin: $((${SIZE} / 1024)) kB"
else
	echo "missing main kernel: uzImage.bin"
	exit 1
fi
...
mcopy -i images/system.bin ../../output/images/kernel/uzImage.bin ::uzImage.bin
sha1sum ../../output/images/kernel/uzImage.bin | cut -d' ' -f1 | mcopy -i images/system.bin - ::uzImage.bin.sha1
